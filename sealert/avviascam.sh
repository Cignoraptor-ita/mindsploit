...
echo -e "\e[01;39mMODULE IMPORTED FROM CIGNOTRACK project      \e[00;38m|\e[00m"
echo -e "\e[00;33mhttps://github.com/Cignoraptor-ita/cignotrack\e[00;38m|\e[00m"
echo -e "\e[00;38m----------------------------------------------\e[00m"
echo " "
sleep 2
echo -e "\e[00;41m                                                                                              \e[00m"
...
echo " "
command -v sendemail >/dev/null 2>&1 || { echo "sendemail it's not installed.  Aborting." >&2; exit 1; }
